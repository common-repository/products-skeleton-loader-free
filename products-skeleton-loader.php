 ...
 * Version:           1.0.0
 * Author:            technodigitz
 * Author URI:        https://codecanyon.net/user/technodigitz/
 * Text Domain:       pslfree
...
function pslfree_wp_row_meta( $links, $file ) {
	if ( plugin_basename( __FILE__ ) === $file ) {
		$row_meta = array(
			'Docs' => '<a href="' . esc_url( 'https://technodigitz.com/docs/wsl' ) . '" target="_blank" aria-label="' . esc_attr__( 'Docs', 'pslfree' ) . '" style="color:green;font-weight:bold">' . esc_html__( 'Documentation', 'pslfree' ) . '</a>',
		);
			...
			foreach ( $notices as $notice ) { ?>
					<div class='notice notice-success is-dismissible pslfree_notice'>
						<p style="font-size: 17px;">
							...
							<a href="<?php esc_html( 'https://www.codester.com/technodigitz?ref=technodigitz' ); ?>">
						...
						<p style="font-size: 15px;text-align: right;display: grid;">
							...
							<a class="pslfree_btn_secondary" href="<?php printf( esc_url( 'https://codester.com/technodigitz?ref=technodigitz' ) ); ?>">
