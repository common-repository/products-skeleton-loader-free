		...
		<div class="header">
			...
			<ul style="list-style: inside;">
				...
				<li><?php printf( esc_html__( 'Enable Image Branding.' ) ); ?> 
					...
					<a class="pro_btn" target="_blank" href="<?php printf( esc_html__( 'https://www.codester.com/technodigitz?ref=technodigitz' ) ); ?>">
							...
							class="pslfree_image_uploader">
								...
								<td>
									<button type="button" class="pslfree_btn_primary support_btn">
										<a target="_blank" href="<?php printf( esc_html__( 'https://www.codester.com/technodigitz?ref=technodigitz' ) ); ?>">
			...
			<div id="support" class="tab-pane">
				<div style="display:block;">
					...
					<p>
						...
						<a href="<?php printf( esc_url( 'mailto:support@technodigitz.com' ) ); ?>">
							<?php printf( esc_html( 'support@technodigitz.com' ) ); ?>
						</a>
						<br />
						<br />
						<br />
						...
						<button type="button" class="pslfree_btn_secondary support_btn">
							<a target="_blank" href="<?php printf( esc_url( 'https://techriver.com.pk/technodigitz/pslfree/docs' ) ); ?>">
